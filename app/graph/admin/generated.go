...
type ComplexityRoot struct {
	...
	Query struct {
		GetTasks func(childComplexity int, companyID string) int
	}
...
type QueryResolver interface {
	GetTasks(ctx context.Context, companyID string) ([]*model.Task, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Query.getTasks":
		...
		return e.complexity.Query.GetTasks(childComplexity, args["companyId"].(string)), true
...
`, BuiltIn: false},
	{Name: "../schema/admin/task.graphql", Input: `input TaskInput {
  AuthorId: ID!
  title: String!
  description: String!
  status: TaskStatus!
...
func (ec *executionContext) _Query_getTasks(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().GetTasks(rctx, fc.Args["companyId"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) unmarshalInputTaskInput(ctx context.Context, obj interface{}) (model.TaskInput, error) {
	...
	fieldsInOrder := [...]string{"AuthorId", "title", "description", "status", "isPrivate", "assigneeIds"}
